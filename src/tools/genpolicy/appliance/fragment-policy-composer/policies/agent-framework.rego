...
# Independently versioned authorization framework for fragment-composed policy.
# Workload and appliance-profile data is supplied only by the packaging stage.
...
substitute_cpath(value) := replace(value, "$(cpath)", policy_data.common.cpath)
